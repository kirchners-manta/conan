...
class TestGraphene:
    ...
    def test_get_direct_neighbors_via_bonds(self, graphene: GrapheneGraph):
        """
        ...
        expected_neighbors = graphene.get_neighbors_via_edges(0)
        assert set(direct_neighbors) == set(
            expected_neighbors
        ), f"Expected {expected_neighbors}, but got {direct_neighbors}"

    def test_get_neighbors_at_exact_depth_via_bonds(self, graphene: GrapheneGraph):
        """
        ...
        """
        graphene = graphene
        depth_neighbors = graphene.get_neighbors_via_edges(atom_id=0, depth=2, inclusive=False)
    ...
    def test_get_neighbors_up_to_depth_via_bonds(self, graphene: GrapheneGraph):
        """
    ...
    def test_get_neighbors_within_distance(self, graphene: GrapheneGraph):
        """
        ...
        atom_id = 56
        max_distance = 5
        neighbors = graphene.get_neighbors_within_distance(atom_id, max_distance)
