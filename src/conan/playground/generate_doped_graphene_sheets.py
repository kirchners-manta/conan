...
def create_graphene_sheets(num_sheets=100, output_folder="graphene_sheets"):
    ...
    for i in range(num_sheets):
        ...
        graphene.add_nitrogen_doping(total_percentage=nitrogen_percentage)
    ...
    print(
        f"{num_sheets} Graphene sheets with varying nitrogen doping have been created and saved in '{output_folder}'."
    )
